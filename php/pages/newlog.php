...
<section id="newlog-header">
    <form id="newlog-form" method="post" action="/php/pages/createlog.php" enctype="multipart/form-data">
        ...
        <div id="fertilizer-form"><!-- Hidden form revealed if yes radio button is clicked -->
            ...
            <input type="number" step="0.1" id="fertilizer-weight" name="fertilizer-weight" min="0">
            <h3>NPK</h3>
            <span>N:</span>
            <input type="number" step="0.1" id="fertilizer-n" name="fertilizer-n" min="0">
            <span>P:</span>
            <input type="number" step="0.1" id="fertilizer-p" name="fertilizer-p" min="0">
            <span>K:</span>
            <input type="number" step="0.1" id="fertilizer-k" name="fertilizer-k" min="0">
        </div>
        ...
        <input type="number" id="number-of-fruits" name="number-of-fruits">
